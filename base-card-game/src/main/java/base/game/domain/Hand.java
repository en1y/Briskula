...
import base.game.domain.exceptions.HandException;
import base.game.domain.interfaces.HandInterface;
...
public class Hand<Card extends AbstractCard> implements HandInterface<Card> {
    ...
    public String toString() {
        ...
        for (int i = 0; i < cardsNum; i++) {
            res.append(i+1).append(". ").append(cards.get(i).toString()).append("\n");
        }
